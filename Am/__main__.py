...
from Am.Handlers.validation import is_user_admin
from Am.Database.users_sql import start_user
...
def Am_about_callback(update: Update, context: CallbackContext):
    first_name = update.effective_user.first_name
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Am_about_callback, pattern=r"Am_", run_async=True)
